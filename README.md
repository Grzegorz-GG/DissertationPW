...
<h3>Experiment 45e:</h3>
<p> Notes: tf_efficientnetv2_m.in21k,PCA = 3</p>

P: Model MSE = 906.2300, Baseline MSE = 956.1005, Normalized = 0.9478<br>
K: Model MSE = 2848.6831, Baseline MSE = 3448.3214, Normalized = 0.8261<br>
Mg: Model MSE = 1281.5688, Baseline MSE = 1448.3911, Normalized = 0.8848<br>
pH: Model MSE = 0.0591, Baseline MSE = 0.0677, Normalized = 0.8738<br>

Challenge normalized score (lower is better, on local test set): 0.8831<br>

</p>
<ul>
    <li>PCA = 3</li>
    <li>changed lr for head -> ~10^-6, backbone ~10^-5, weight decay ~10^-4, batch 32</li>
    <li>tf_efficientnetv2_m.in21k, pretrained = True</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
...
<h3>Experiment 45f:</h3>
<p> Notes: tf_efficientnetv2_l.in21k,PCA = 3</p>

P: Model MSE = 910.9230, Baseline MSE = 956.1005, Normalized = 0.9527<br>
K: Model MSE = 2593.8318, Baseline MSE = 3448.3214, Normalized = 0.7522<br>
Mg: Model MSE = 1228.9819, Baseline MSE = 1448.3911, Normalized = 0.8485<br>
pH: Model MSE = 0.0632, Baseline MSE = 0.0677, Normalized = 0.9345<br>

Challenge normalized score (lower is better, on local test set): 0.8720<br>

</p>
<ul>
    <li>PCA = 3</li>
    <li>changed lr for head -> ~10^-5, backbone ~10^-4, weight decay ~10^-4, batch 32</li>
    <li>tf_efficientnetv2_l.in21k, pretrained = True</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
            <li>v2.RandomHorizontalFlip(p=0.5)</li>
...
<h3>Experiment 46a:</h3>
<p> Notes: coatnet_3_rw_224.sw_in12k,PCA = 3</p>

P: Model MSE = 890.6203, Baseline MSE = 956.1005, Normalized = 0.9315<br>
K: Model MSE = 2475.1248, Baseline MSE = 3448.3214, Normalized = 0.7178<br>
Mg: Model MSE = 1177.7917, Baseline MSE = 1448.3911, Normalized = 0.8132<br>
pH: Model MSE = 0.0607, Baseline MSE = 0.0677, Normalized = 0.8969<br>

Challenge normalized score (lower is better, on local test set): 0.8398<br>
...
<h3>Experiment 46b:</h3>
<p> Notes: coatnet_2_rw_224.sw_in12k,PCA = 3</p>

P: Model MSE = 883.7568, Baseline MSE = 956.1005, Normalized = 0.9243<br>
K: Model MSE = 2478.6013, Baseline MSE = 3448.3214, Normalized = 0.7188<br>
Mg: Model MSE = 1177.5975, Baseline MSE = 1448.3911, Normalized = 0.8130<br>
pH: Model MSE = 0.0598, Baseline MSE = 0.0677, Normalized = 0.8833<br>

Challenge normalized score (lower is better, on local test set): 0.8349<br>
...
P: Model MSE=884.8987  Baseline MSE=956.1005  Normalized=0.9255<br>
K: Model MSE=2654.0217  Baseline MSE=3448.3214  Normalized=0.7697<br>
Mg: Model MSE=1236.0804  Baseline MSE=1448.3911  Normalized=0.8534<br>
pH: Model MSE=0.0618  Baseline MSE=0.0677  Normalized=0.9140<br>

Challenge score (lower is better): 0.8656 <br>
...
<h3>Experiment 54a:</h3>
<p> PCA=3, regnety_120</p>

P: Model MSE=848.4077  Baseline MSE=956.1005  Normalized=0.8874<br>
K: Model MSE=2613.5232  Baseline MSE=3448.3214  Normalized=0.7579<br>
Mg: Model MSE=1260.6423  Baseline MSE=1448.3911  Normalized=0.8704<br>
pH: Model MSE=0.0624  Baseline MSE=0.0677  Normalized=0.9222<br>

Challenge score (lower is better): 0.8595<br>

</p>
<ul>
    <li> head ~10^4, backbone ~10^-5, weight decay ~10^-4, batch 32</li>
    <li>regnety_120d, pretrained = true</li>
    <li>PCA=3</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
...
<h3>Experiment 54b:</h3>
<p> PCA=3, regnety_120.sw_in12k_ft_in1k</p>

P: Model MSE = 911.3868, Baseline MSE = 956.1005, Normalized = 0.9532<br>
K: Model MSE = 2620.3103, Baseline MSE = 3448.3214, Normalized = 0.7599<br>
Mg: Model MSE = 1212.5120, Baseline MSE = 1448.3911, Normalized = 0.8371<br>
pH: Model MSE = 0.0623, Baseline MSE = 0.0677, Normalized = 0.9208<br>

Challenge normalized score (lower is better, on local test set): 0.8678<br>

</p>
<ul>
    <li> head ~10^4, backbone ~10^-5, weight decay ~10^-4, batch 32</li>
    <li>regnety_120.sw_in12k_ft_in1k, pretrained = true</li>
    <li>PCA=3</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
...
<h3>Experiment 54c:</h3>
<p> PCA=3, regnety_160</p>

P: Model MSE = 865.3087, Baseline MSE = 956.1005, Normalized = 0.9050<br>
K: Model MSE = 2563.8843, Baseline MSE = 3448.3214, Normalized = 0.7435<br>
Mg: Model MSE = 1203.9977, Baseline MSE = 1448.3911, Normalized = 0.8313<br>
pH: Model MSE = 0.0603, Baseline MSE = 0.0677, Normalized = 0.8905<br>

Challenge normalized score (lower is better, on local test set): 0.8426

</p>
<ul>
    <li> head ~10^4, backbone ~10^-5, weight decay ~10^-4, batch 32</li>
    <li>regnety_160, pretrained = true</li>
    <li>PCA=3</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
...
<h3>Experiment 54d:</h3>
<p> PCA=3, regnety_320</p>

P: Model MSE = 929.4095, Baseline MSE = 956.1005, Normalized = 0.9721<br>
K: Model MSE = 2782.4006, Baseline MSE = 3448.3214, Normalized = 0.8069<br>
Mg: Model MSE = 1278.9253, Baseline MSE = 1448.3911, Normalized = 0.8830<br>
pH: Model MSE = 0.0723, Baseline MSE = 0.0677, Normalized = 1.0683<br>

Challenge normalized score (lower is better, on local test set): 0.9326<br>

</p>
<ul>
    <li> head ~10^4, backbone ~10^-5, weight decay ~10^-4, batch 32</li>
    <li>regnety_320, pretrained = true</li>
    <li>PCA=3</li>
    <li>augmentations for training:
        <ul>
            <li> v2.RandomResizedCrop(size=self.size, scale=(0.8, 1.0))</li>li>
